...
[触发抓取工具，获取批量采集方法](/api-reference/web-scraper-ide-api/Trigger_a_scraper_for_batch_collection_method)
<CodeGroup>
```sh Shell
...
[Trigger a scraper for real-time collection](/api-reference/web-scraper-ide-api/Receive_data_from_real_time_work_scraper)
...
<Step title="接收数据">
- [接收批量数据](/api-reference/web-scraper-ide-api/Receive_batch_data)
- [由实时工作抓取工具接收数据](/api-reference/web-scraper-ide-api/Receive_data_from_real_time_work_scraper)
</Step>
 </Steps>