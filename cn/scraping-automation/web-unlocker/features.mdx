...
If you want to target from a specific **country** in 网络解锁器 refer to [geolocation targeting](https://docs.brightdata.com/cn/api-reference/proxy/geolocation-targeting).
...
#### Custom features:
- [Manual headers & cookies](/cn/scraping-automation/web-unlocker/features#manual-headers-and-cookies)
...
Once enabled, you can now send Custom 网络解锁器 requests in accordance with each [custom feature's](/cn/scraping-automation/web-unlocker/features#custom-features) procedure.
...
https://docs.brightdata.com/cn/general/account/billing-and-pricing/payment
...
| [403](/cn/proxy-networks/faqs#what-is-error-code-403) | 您尝试访问的 URL 有效，但您被禁止访问该 URL。|
| [502](/cn/proxy-networks/faqs#what-is-error-code-502) | 错误代码502是网络解锁器用户最常见的错误，描述部分位于 `x-luminati-error-code` 下。|
...
[API token](https://docs.brightdata.com/cn/general/account/api-token#bright-datas-api-token)
