...
[generate an API Token](https://docs.brightdata.com/general/account/api-token#how-to-create-a-bright-datas-api-token), [API documentation](https://docs.brightdata.com/scraping-automation/web-scraper-api/overview)
<iframe
  width="640"
  height="480"
...
[detailed API parameters documentation](https://docs.brightdata.com/scraping-automation/web-data-apis/web-scraper-api/trigger-a-collection)
</Accordion>
...
<Accordion title="For how long a snapshot is available after I triggered a collection?">
 ...
 you can retrieve the snapshot during this time period via [delivery API](https://docs.brightdata.com/scraping-automation/web-data-apis/web-scraper-api/delivery-apis) options and the snapshot ID  
