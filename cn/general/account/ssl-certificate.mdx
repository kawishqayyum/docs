...
title: SSL 证书
---
The SSL certificate allows you to establish end-to-end encrypted connections when using [Residential Proxies](https://docs.brightdata.com/cn/proxy-networks/residential/introduction), the [Web Unlocker](https://docs.brightdata.com/cn/scraping-automation/web-unlocker/introduction) or the [SERP API](https://docs.brightdata.com/cn/scraping-automation/serp-api/introduction).
