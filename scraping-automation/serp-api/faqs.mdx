...
查看我们谷歌图片 SERP 的其余功能:  
https://docs.brightdata.com/api-reference/serp/images
...
当您使用“谷歌搜索”搜索特定酒店时，其详细信息和评论会出现在下面右侧的知识图谱/小工具中：
  ...
  https://docs.brightdata.com/scraping-automation/serp-api/parsing-search-results#hotels
...
Go to the control panel [API Guide](https://brightdata.com/cp/serp_api/api/google/hotels) for an explanation of how to target this page and the dedicated parameters you can use or see our [API documentation](/scraping-automation/serp-api/parsing-search-results#hotels).
...
<Tab title="其他编程语言">
Follow the instructions in the following article on [how to download and Install the Bright Data certificate](https://docs.brightdata.com/general/account/ssl-certificate) to your local machine's Trusted Root Certification Authorities.
...
请参阅这篇文章: [解析搜索结果](/scraping-automation/serp-api/parsing-search-results)
...
<Note>
**条件：**
* 仅支持已启用异步请求的区域: https://docs.brightdata.com/scraping-automation/serp-api/asynchronous-requests
* 仅支持谷歌搜索
* 仅限 2 个请求
* 按 2 个请求计费
</Note>
