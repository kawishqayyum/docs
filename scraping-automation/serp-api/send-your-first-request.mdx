...
[SSL certificate](/general/account/ssl-certificate#how-to-download-the-ssl-certificate), [ignore SSL errors](/general/account/ssl-certificate#how-to-ignore-ssl-errors)
</Warning>
<CodeGroup>
```sh cURL
...
[解析搜索结果](/scraping-automation/serp-api/parsing-search-results)